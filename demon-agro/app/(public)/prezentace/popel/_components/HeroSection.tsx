...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-600 via-amber-500 to-yellow-400">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto py-20">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight animate-fade-in-up">
          Popel:<br />
          <span className="text-yellow-100">1 000 Kč/t</span> včetně všeho
        </h1>
        
        <p className="text-lg md:text-xl text-white/95 mb-3 max-w-3xl mx-auto animate-fade-in-up animation-delay-200 font-medium">
          Draslík + fosfor + vápník v jednom přejezdu · 3 t/ha
        </p>
        
        <p className="text-base md:text-lg text-white/90 mb-8 max-w-2xl mx-auto animate-fade-in-up animation-delay-300">
          Materiál, doprava i aplikace — vše v ceně. Bez DPH.
        </p>
        
        <button
          onClick={scrollToContact}
          className="inline-block bg-white text-orange-600 px-10 py-4 rounded-full font-bold transition-all duration-300 shadow-2xl hover:shadow-3xl text-lg hover:scale-105 animate-fade-in-up animation-delay-400"
        >
          Nezávazná poptávka
        </button>
