...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 via-green-500 to-emerald-400">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto py-20">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight animate-fade-in-up">
          Energosádrovec:<br />
          <span className="text-yellow-300">750-850 Kč/ha</span> včetně všeho
        </h1>
        
        <p className="text-lg md:text-xl text-white/95 mb-3 max-w-3xl mx-auto animate-fade-in-up animation-delay-200 font-medium">
          Síra + vápník bez okyselení půdy · 500 kg/ha
        </p>
        
        <p className="text-base md:text-lg text-white/90 mb-8 max-w-2xl mx-auto animate-fade-in-up animation-delay-300">
          Aplikace únor-březen. Doprava, rozhození i technologie — vše v ceně.
        </p>
        
        <button
          onClick={scrollToContact}
          className="inline-block bg-white text-green-600 px-10 py-4 rounded-full font-bold transition-all duration-300 shadow-2xl hover:shadow-3xl text-lg hover:scale-105 animate-fade-in-up animation-delay-400"
        >
          Nezávazná poptávka
        </button>
