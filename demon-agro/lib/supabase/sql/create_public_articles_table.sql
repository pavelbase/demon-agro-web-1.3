-- ============================================================================
-- TABULKA PRO VZDĚLÁVACÍ ČLÁNKY VEŘEJNÉ ČÁSTI WEBU
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS public.public_articles (
  ...
  -- Validace kategorie
  CONSTRAINT public_articles_category_check CHECK (category IN ('ziviny', 'metodiky', 'technologie', 'ekonomika', 'legislativa'))
);
